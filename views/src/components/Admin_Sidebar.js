...
function Admin_Sidebar({ setToken }) {
	const handleLogout = () => {
					...
					<Link to='/admin/' className='link'>
						<li>
							<p className='p-dashboard'>
								<i className='fa-sharp fa-solid fa-house-chimney'></i>Dashboard
							</p>
						</li>
					</Link>
					...
					<Link to='/admin/products' className='link'>
						<li>
							<p className='p-products'>
								<i className='fa-sharp fa-solid fa-boxes-packing'></i>Products
							</p>
						</li>
					</Link>
